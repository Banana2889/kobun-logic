...
def inject_miyabi_style():
    st.markdown("""
    <style>
    /* 全体背景とフォント対策：iOS, Android, Windows対応 */
    .stApp { 
    ...
    .result-box h3, .result-box p, .result-box strong { color: #000000 !important; }
    ...
    @keyframes explode {
        ...
        20% { opacity: 1; }
        100% { opacity: 0; transform: translate(var(--tx), var(--ty)) scale(2) rotate(var(--tr)); }
    }
    </style>
...
def inject_result_animation(is_correct):
    ...
    if is_correct:
        ...
        anim_placeholder.markdown(petals, unsafe_allow_html=True)
        time.sleep(1.5)
    else:
...
scenes = [
    ...
    {"title": "第2章：兄弟の再会", "context": "挙兵した兄の元へ駆けつけ、忠義を誓う。", "options": [{"text": "「御前に畏まりて、九郎義経、参り候ふ」", "correct": True, "feedback": "【正解】兄・頼朝への忠誠心が伝わります。"}, {"text": "「御前に畏まりて、九郎義経、参り給ふ」", "correct": False, "feedback": "【失敗】己の参上に尊敬語は不要です。"}, {"text": "「御前に畏まりて、九郎義経、来たり候ふ」", "correct": False, "feedback": "【失敗】「参る」が最も相応しいでしょう。"}, {"text": "「御前に畏まりて、九郎義経、見えさせ給ふ」", "correct": False, "feedback": "【失敗】敬語の使い方が不自然です。"}]},
    {"title": "第3章：激流を越えて", "context": "宇治川の早瀬を突破しなければならない。", "options": [{"text": "「まっさきに喚いて、宇治川の早瀬をぞ押し渡り給ふ」", "correct": True, "feedback": "【正解】勇猛果敢な姿が見事に描かれています。"}, {"text": "「まっさきに喚いて、宇治川の早瀬をぞ渡りおはします」", "correct": False, "feedback": "【失敗】「給ふ」が最も勢いがあります。"}, {"text": "「まっさきに喚いて、宇治川の早瀬をぞ見送り給ふ」", "correct": False, "feedback": "【失敗】見送っていては勝利は掴めませぬ。"}, {"text": "「まっさきに喚いて、宇治川の早瀬をぞなぶり給ふ」", "correct": False, "feedback": "【失敗】不適切な表現です。"}]},
    {"title": "第4章：絶壁の奇襲", "context": "険しい地形から一気に攻め下る。", "options": [{"text": "「義経、三十騎ばかりを率て、真っ逆様におとし給ふ」", "correct": True, "feedback": "【正解】鵯越の奇襲、お見事です。"}, {"text": "「三十騎ばかりを率て、おとしおはします」", "correct": False, "feedback": "【失敗】「給ふ」が相応しい場面です。"}, {"text": "「三十騎ばかりを率て、山陰に隠れ給ふ」", "correct": False, "feedback": "【失敗】奇襲になりませぬ。"}, {"text": "「三十騎ばかりを率て、見守り給ふ」", "correct": False, "feedback": "【失敗】勝利は得られませぬ。"}]},
    {"title": "第5章：嵐の船出", "context": "荒れる海を前に、敵の意表を突く。", "options": [{"text": "「追い風なればこそ、船をば出だすなれ」", "correct": True, "feedback": "【正解】これぞ義経の真骨頂。"}, {"text": "「追い風なればこそ、船をば出ださせ給ふ」", "correct": False, "feedback": "【失敗】強意の「なれ」が相応しいです。"}, {"text": "「追い風なればこそ、船をば留むるなれ」", "correct": False, "feedback": "【失敗】機を逃します。"}, {"text": "「追い風なればこそ、船をば弄び給ふ」", "correct": False, "feedback": "【失敗】不真面目な印象です。"}]},
    {"title": "第6章：誇りの回収", "context": "弓を落としてしまう。敵の嘲笑を防ぐため自ら動く。", "options": [{"text": "「鞭をもって、弓をかき寄せ、ついに取りてぞ帰り給ふ」", "correct": True, "feedback": "【正解】弓流し。武士の誇りを守り抜きました。"}, {"text": "「鞭をもって、弓を打ち捨て、ついに取りてぞ帰り給ふ」", "correct": False, "feedback": "【失敗】嘲笑の的になります。"}, {"text": "「鞭をもって、弓を拾い取らせ給ふ」", "correct": False, "feedback": "【失敗】自らの手で取り戻すことに意味があります。"}, {"text": "「鞭をもって、弓を笑いおはします」", "correct": False, "feedback": "【失敗】笑っている場合ではございませぬ。"}]},
    {"title": "第7章：非情の采配", "context": "敵の機動力を奪うため、船人を射るよう命じる。", "options": [{"text": "「あやまちすな、水手・梶取を射よ」", "correct": True, "feedback": "【正解】勝利を決定づける非情の采配です。"}, {"text": "「あやまちすな、水手・梶取を射させ給ふ」", "correct": False, "feedback": "【失敗】軍の緊張感を表します。"}, {"text": "「あやまちすな、水手・梶取を助けよ」", "correct": False, "feedback": "【失敗】敵を止められませぬ。"}, {"text": "「あやまちすな、水手・梶取をなぶり殺せ」", "correct": False, "feedback": "【失敗】残酷すぎます。"}]},
    {"title": "第8章：窮地の跳躍", "context": "敵が迫る。船から船へ飛び移る。", "options": [{"text": "「ゆらりと飛びのき、二丈ばかりの船のわたりを、飛びわたり給ふ」", "correct": True, "feedback": "【正解】八艘飛び、お見事。"}, {"text": "「ゆらりと飛びのきおはし、船のわたりをわたり給ふ」", "correct": False, "feedback": "【失敗】勢いが削がれます。"}, {"text": "「ゆらりと踏みとどまり、船のわたりを飛びわたり給ふ」", "correct": False, "feedback": "【失敗】捕まってしまいます。"}, {"text": "「ゆらりと立ち止まり給ひ、船のわたりを眺め給ふ」", "correct": False, "feedback": "【失敗】眺めている暇はございませぬ。"}]},
    {"title": "第9章：偽装の忍耐", "context": "山伏の態にて、関所を抜けようとする。", "options": [{"text": "「義経、杖を突いて、山伏の態にて、急ぎ通り給ふ」", "correct": True, "feedback": "【正解】安宅の関、緊迫の場面です。"}, {"text": "「義経、杖を突いて、山伏の態にて、歩ませ給ふ」", "correct": False, "feedback": "【失敗】急ぐことが肝要です。"}, {"text": "「義経、杖を突いて、山伏の態にて、物申し給ふ」", "correct": False, "feedback": "【失敗】怪しまれてしまいます。"}, {"text": "「義経、杖を突いて、山伏の態にて、命じ給ふ」", "correct": False, "feedback": "【失敗】不自然な振る舞いです。"}]},
...
if st.session_state.app_mode == 'pre_mapping':
    ...
    st.balloons()
    st.header("🎊 調査完了。感謝いたします")
    st.markdown("### ⚠️ 【重要】以下の白い枠内をスクリーンショットして提出してください")
    
    # テキスト回答をまとめる処理
    pre_ans = "<br>".join([f"・{k[:10]}...: {v}" for k,v in st.session_state.pre_text.items()])
    post_ans = "<br>".join([f"・{k[:10]}...: {v}" for k,v in st.session_state.post_text.items()])
    ...
    <div class="result-box">
        ...
        <p><strong>■ アンケート数値（事前 / 事後）:</strong><br>事前:{list(st.session_state.pre_likert.values())} / 事後:{list(st.session_state.post_likert.values())}</p>
        <hr style="border: 1px dashed #000;">
        <p><strong>■ 事前記述回答摘要:</strong><br><small>{pre_ans}</small></p>
        <p><strong>■ 事後記述回答摘要:</strong><br><small>{post_ans}</small></p>
        <p style="text-align: center; font-size: 0.7rem; border-top: 1px solid #000; padding-top: 5px;">この画面全体を保存して研究者へ送信してください。</p>
    </div>
    """
