...
# --- 全10章の問題データ ---
scenes = [
    {"title": "第1章：闇夜の決意", "context": "修行の裏で密かに一族の再興を期して牙を研ぎ続ける。", "options": [{"text": "「昼は寺に読経し、夜は貴船の奥にのぼりて、兵法をぞ習ひける」", "score": 10, "correct": True, "feedback": "【正解】夜な夜な兵法に励む姿が目に浮かびます。"}, {"text": "「夜は貴船の奥にのぼりて、兵法をぞ習いおはします」", "score": -10, "correct": False, "feedback": "【失敗】敬語が不適切です。"}]},
    {"title": "第2章：兄弟の再会", "context": "挙兵した兄の元へ駆けつけ、忠義を誓う。", "options": [{"text": "「御前に畏まりて、九郎義経、参り候ふ」", "score": 10, "correct": True, "feedback": "【正解】兄・頼朝への忠誠心が伝わります。"}, {"text": "「御前に畏まりて、九郎義経、参り給ふ」", "score": -10, "correct": False, "feedback": "【失敗】己の動作に尊敬語は使いません。"}]},
    {"title": "第3章：激流を越えて", "context": "宇治川の早瀬を突破しなければならない。", "options": [{"text": "「まっさきに喚いて、宇治川の早瀬をぞ押し渡り給ふ」", "score": 10, "correct": True, "feedback": "【正解】勇猛果敢な姿が見事に描かれています。"}, {"text": "「まっさきに喚いて、宇治川の早瀬をぞ見送り給ふ」", "score": -10, "correct": False, "feedback": "【失敗】渡らねば勝利はありませぬ。"}]},
    {"title": "第4章：絶壁の奇襲", "context": "険しい地形から一気に攻め下る。", "options": [{"text": "「義経、三十騎ばかりを率て、真っ逆様におとし給ふ」", "score": 10, "correct": True, "feedback": "【正解】鵯越の奇襲、お見事です。"}, {"text": "「三十騎ばかりを率て、山陰に隠れ給ふ」", "score": -10, "correct": False, "feedback": "【失敗】奇襲になりませぬ。"}]},
    {"title": "第5章：嵐の船出", "context": "荒れる海を前に、敵の意表を突く。", "options": [{"text": "「追い風なればこそ、船をば出だすなれ」", "score": 10, "correct": True, "feedback": "【正解】これぞ義経の真骨頂。"}, {"text": "「追い風なればこそ、船をば留むるなれ」", "score": -10, "correct": False, "feedback": "【失敗】機を逃します。"}]},
    {"title": "第6章：誇りの回収", "context": "戦いの最中、弓を落としてしまう。", "options": [{"text": "「鞭をもって、弓をかき寄せ、ついに取りてぞ帰り給ふ」", "score": 10, "correct": True, "feedback": "【正解】弓流し。武士の誇りを守りました。"}, {"text": "「鞭をもって、弓を打ち捨て、ついに取りてぞ帰り給ふ」", "score": -10, "correct": False, "feedback": "【失敗】敵の嘲笑を浴びてしまいます。"}]},
    {"title": "第7章：非情の采配", "context": "敵の機動力を奪うため、船人を狙う。", "options": [{"text": "「あやまちすな、水手・梶取を射よ」", "score": 10, "correct": True, "feedback": "【正解】勝利を決定づける非情の采配です。"}, {"text": "「あやまちすな、水手・梶取を助けよ」", "score": -10, "correct": False, "feedback": "【失敗】敵を止められませぬ。"}]},
    {"title": "第8章：窮地の跳躍", "context": "敵が迫る。船から船へ飛び移る。", "options": [{"text": "「ゆらりと飛びのき、二丈ばかりの船のわたりを、飛びわたり給ふ」", "score": 10, "correct": True, "feedback": "【正解】八艘飛び、お見事。"}, {"text": "「ゆらりと立ち止まり給ひ、船のわたりを眺め給ふ」", "score": -10, "correct": False, "feedback": "【失敗】捕まってしまいます。"}]},
    {"title": "第9章：偽装の忍耐", "context": "山伏の姿で関所を抜けようとする。", "options": [{"text": "「義経、杖を突いて、山伏の態にて、急ぎ通り給ふ」", "score": 10, "correct": True, "feedback": "【正解】安宅の関、緊迫の場面です。"}, {"text": "「義経、杖を突いて、山伏の態にて、物申し給ふ」", "score": -10, "correct": False, "feedback": "【失敗】怪しまれてしまいます。"}]},
    {"title": "第10章：静かなる終幕", "context": "最期の時。自ら幕を引く準備を整える。", "options": [{"text": "「持仏堂の戸を強くしめ、内よりかんぬきをさして、自害し給ふ」", "score": 10, "correct": True, "feedback": "【正解】最期まで誇り高き姿、感服いたしました。"}, {"text": "「戸を強くしめ、内よりかんぬきをさして、逃げおはします」", "score": -10, "correct": False, "feedback": "【失敗】もはや道は残されておりませぬ。"}]}
]
